...
namespace StorageStrategy.Data.Migrations
{
    ...
    [Migration("20250826191609_Client_ColumnActive")]
    partial class ClientColumnActive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StorageStrategy.Models.CompanyEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            CNPJ = "",
                            CreateAt = new DateTime(2025, 8, 26, 16, 16, 8, 245, DateTimeKind.Local).AddTicks(616),
                            Description = "Admin",
                            IsActive = true,
                            Name = "Admin Company",
                            Phone = "",
                            Validate = new DateTime(2035, 8, 26, 16, 16, 8, 245, DateTimeKind.Local).AddTicks(638)
                        });
                });
            ...
            modelBuilder.Entity("StorageStrategy.Models.EmployeeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$QoVLa7JuX/ogAINUS3pxUA$gNDtRfA/K8BZVBspwBU2ivcn0APGVU6V1idp21dBHzY"
                        });
                });
