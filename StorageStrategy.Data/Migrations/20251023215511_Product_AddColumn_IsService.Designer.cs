...
namespace StorageStrategy.Data.Migrations
{
    ...
    [Migration("20251023215511_Product_AddColumn_IsService")]
    partial class ProductAddColumnIsService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StorageStrategy.Models.CompanyEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            CNPJ = "",
                            CreateAt = new DateTime(2025, 10, 23, 18, 55, 10, 738, DateTimeKind.Local).AddTicks(8175),
                            Description = "Admin",
                            IsActive = true,
                            Name = "Admin Company",
                            Phone = "",
                            Validate = new DateTime(2035, 10, 23, 18, 55, 10, 738, DateTimeKind.Local).AddTicks(8193)
                        });
                });
            ...
            modelBuilder.Entity("StorageStrategy.Models.EmployeeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$e5HKd4T+V4TQYHSr70Yt1g$e/8By8dyu1OG6tFzBE6nO15VfjgHscs0xjF8xcDxKvM"
                        });
                });
