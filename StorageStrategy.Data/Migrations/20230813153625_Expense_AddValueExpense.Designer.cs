...
namespace StorageStrategy.Data.Migrations
{
    ...
    [Migration("20230813153625_Expense_AddValueExpense")]
    partial class ExpenseAddValueExpense
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StorageStrategy.Models.CompanyEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CompanyId = 1,
                            CreateAt = new DateTime(2023, 8, 13, 12, 36, 24, 423, DateTimeKind.Local).AddTicks(3412),
                            Description = "Admin",
                            IsActive = true,
                            Name = "Admin Company",
                            Validate = new DateTime(2033, 8, 13, 12, 36, 24, 423, DateTimeKind.Local).AddTicks(3426)
                        });
                });
            ...
            modelBuilder.Entity("StorageStrategy.Models.EmployeeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$g0A9Ac1SgLWMQSYC+XHnrQ$q7FaM8QP3BiAm2hHzDwHoYumfnWe3HTXf4Ja+5Yt3Kc"
                        });
                });
