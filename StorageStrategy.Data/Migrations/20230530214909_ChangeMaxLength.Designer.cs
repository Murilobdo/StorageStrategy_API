...
namespace StorageStrategy.Data.Migrations
{
    ...
    [Migration("20230530214909_ChangeMaxLength")]
            ...
            modelBuilder.Entity("StorageStrategy.Models.CompanyEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CompanyId = 1,
                            CreateAt = new DateTime(2023, 5, 30, 18, 49, 7, 900, DateTimeKind.Local).AddTicks(8818),
                            Description = "Admin",
                            IsActive = true,
                            Name = "Admin Company",
                            Validate = new DateTime(2033, 5, 30, 18, 49, 7, 900, DateTimeKind.Local).AddTicks(8835)
                        });
                });
            ...
            modelBuilder.Entity("StorageStrategy.Models.EmployeeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$A66BQt0ZV7pbBJ4ARD6BSQ$oMnuj8ImqYFdv6cFf38rf1S3GPR/vzcAcqXBe3oTGcE"
                        });
                });
