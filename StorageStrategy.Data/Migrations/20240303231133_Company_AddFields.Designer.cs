...
namespace StorageStrategy.Data.Migrations
{
    ...
    [Migration("20240303231133_Company_AddFields")]
    partial class CompanyAddFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StorageStrategy.Models.CompanyEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            CNPJ = "",
                            CreateAt = new DateTime(2024, 3, 3, 20, 11, 31, 913, DateTimeKind.Local).AddTicks(601),
                            Description = "Admin",
                            IsActive = true,
                            Name = "Admin Company",
                            Phone = "",
                            Validate = new DateTime(2034, 3, 3, 20, 11, 31, 913, DateTimeKind.Local).AddTicks(621)
                        });
                });
            ...
            modelBuilder.Entity("StorageStrategy.Models.EmployeeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$IwAFNFrheuYBCOjAdzhlPQ$SbORLXTbw7B4Y2qiIp0KUBDbO4vKrAR0U4ehkc2lnYM"
                        });
                });
