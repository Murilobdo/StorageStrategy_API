...
namespace StorageStrategy.Tests.Commands.Product
{
    public class CreateProductCommandTest : CommandBaseTest
    {
        ...
        {
            CreateProductCommand createProduct = new(1, "Sucesso Produto", 10, 20, 5, 10, true, 1, 1);
        ...
        {
            CreateProductCommand createProduct = new(1, string.Empty, 10, 20, 5, 10, true, 1, 1);
        ...
        {
            CreateProductCommand createProduct = new(1, "Sucesso Produto", 0, 20, 5, 10, true, 1, 1);
        ...
        {
            CreateProductCommand createProduct = new(1, "Sucesso Produto", 10, 0, 5, 10, true, 1, 1);
        ...
        {
            CreateProductCommand createProduct = new(1, "Sucesso Produto", 10, 20, 0, 10, true, 1, 1);
        ...
        {
            CreateProductCommand createProduct = new(1, "Sucesso Produto", 10, 20, 5, 10, true, 0, 1);
        ...
        {
            CreateProductCommand createProduct = new(1, "Sucesso Produto", 10, 20, 5, 10, true, 1, 0);
