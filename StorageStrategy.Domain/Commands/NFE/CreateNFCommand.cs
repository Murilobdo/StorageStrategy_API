...
using StorageStrategy.Domain.Validations.NFE;
using StorageStrategy.Models;

namespace StorageStrategy.Domain.Commands.NFE
{
    public record class CreateNFCommand : CommandBase
    {
        ...
        public bool IsValid() => new NFCeValidation().Validate(this).IsValid;
        public List<Error> GetErros() => new NFCeValidation().Validate(this)
